...
public class Tripgain_registrationpage {
	...
	public void clickregisterpage() {
	    ...
	    System.out.println("Now on page: " + driver.getCurrentUrl());
	}


//Method to select salutation dropdown (mr,mrs---)
	@FindBy(xpath = "(//div[@role=\"combobox\"])[1]")
	WebElement salutationDropdown;

	public void selectSalutation(String title) throws AWTException, InterruptedException {
	    new WebDriverWait(driver, Duration.ofSeconds(90))
	        .until(ExpectedConditions.elementToBeClickable(salutationDropdown));
	...
	//Method to select registrationas dropdown
	...
	public void entercompanyname(String companyName) {
		companyname.sendKeys(companyName); //TripGain
	}
	...
	public void enterworkemail(String email) { 
		workemail.sendKeys(email);   //testtravel@tripgain.com
	}

	@FindBy(xpath="//input[@name=\"mobile_number\"]")
	WebElement mobile;

	public void entermobile(String phoneNum) {
		mobile.sendKeys(phoneNum);  //9882981289
	}
	...
	public void enterpassword(String enterpassword) {
		password.sendKeys(enterpassword); //Testtravel@tripgain
	}

	//method to click on register buuton
	...
	//Method to registration
		public void userRegistration(Log Log,ScreenShots ScreenShots,String salutation,String firstName,String lastName, String companyName, String email, String phoneNum, String password, String registerAs)
		{
			...
			try {
			    ...
			    enterfirstname(firstName);          // Pass the first name string here
			    enterlastname(lastName);            // Pass the last name string here
			    entercompanyname(companyName);      // Pass the company name string here
			    enterworkemail(email);              // Pass the email string here
			    entermobile(phoneNum);              // Pass the phone number string here
			    enterpassword(password);       // Pass the password string here
			    selectregistrationas(registerAs);

			}
			catch(Exception e)
		{
				  Log.ReportEvent("FAIL", "Registration Was UnSuccesfull");
