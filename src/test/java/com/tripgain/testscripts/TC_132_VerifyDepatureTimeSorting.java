...
public class TC_132_VerifyDepatureTimeSorting extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
      ...
      // Map<String, String> excelData = getDataFromExcel.getExcelData("TC_132");
       ...
       String order2 = excelData.get("Order2");
        ...
        tripgainresultspage.validateDepartureTimeSortFunctionalityOnResultScreen(Log, screenShots, order1);
        Thread.sleep(5000);
        tripgainresultspage.clickOnFiltersOnResultScreen(filtername);
        tripgainresultspage.validateDepartureTimeSortFunctionalityOnResultScreen(Log, screenShots, order2);
    	 driver.quit();
       }
