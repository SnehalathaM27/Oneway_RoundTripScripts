...
public class TC_164_SwapSearch extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
     ...
     //  Map<String, String> excelData = getDataFromExcel.getExcelData("TC_164");
       ...
       int adults = Integer.parseInt(excelData.get("Adults"));
        ...
        Thread.sleep(5000);
        tripgainresultspage.validateAirportSwap(Log, screenShots);
        Thread.sleep(2000); 
        tripgainhomepage.clickOnSearchButton(); 
