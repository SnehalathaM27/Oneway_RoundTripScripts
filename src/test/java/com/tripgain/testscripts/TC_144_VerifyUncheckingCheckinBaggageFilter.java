...
public class TC_144_VerifyUncheckingCheckinBaggageFilter extends BaseClass {
    ...
    //   Map<String, String> excelData = getDataFromExcel.getExcelData("TC_144");
      ...
      //Function to validate Check In Baggage Functionality on Result Screen
        ...
        tripgainresultspage.checkinBaggage(checkinbaggageindex);
  		
        //Function to validate UnCheck In Baggage Functionality on Result Screen
		tripgainresultspage.clickOnCheckInBaggage();
        tripgainresultspage.validateCheckInBaggageFlightsOnResultScreenByUnChecking(Log, screenShots);
