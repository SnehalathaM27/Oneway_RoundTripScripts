...
public class TC_196_TripgainRegisteration extends BaseClass {
	WebDriver driver;    
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException, AWTException {
       ...
       String registerAs = excelData.get("RegisterAs");
		...
		Tripgain_registrationpage tripgain_registrationpage = new Tripgain_registrationpage(driver);
		
		tripgain_registrationpage.userRegistration(Log, screenShots, salutation, FirstName, LastName, CompanyName, Email, PhoneNum, Password, registerAs);
		Log.ReportEvent("", "");
