...
public class TC_131_VerifyAirlineSorting extends BaseClass {
    ...
    //   Map<String, String> excelData = getDataFromExcel.getExcelData("TC_131");
      ...
      //  tripgainhomepage.searchFlightsOnHomePage("BLR", "DEL",  fromDate, fromMonthYear, "Premium Economy", 3, Log, screenShots);
