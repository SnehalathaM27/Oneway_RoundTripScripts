...
public class TC_135_VerifyPriceSorting extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
       ...
       //Map<String, String> excelData = getDataFromExcel.getExcelData("TC_135");
       ...
       String order2 = excelData.get("Order2");
        ...
        Thread.sleep(3000); 
        //Function to validate Price Functionality
        tripgainresultspage.clickOnFiltersOnResultScreen("PRICE");
        tripgainresultspage.validatePriceSortFunctionalityOnResultScreen(Log, screenShots, "Ascending");
        Thread.sleep(5000);
        tripgainresultspage.clickOnFiltersOnResultScreen("PRICE");
        tripgainresultspage.validatePriceSortFunctionalityOnResultScreen(Log, screenShots, "Descending");
