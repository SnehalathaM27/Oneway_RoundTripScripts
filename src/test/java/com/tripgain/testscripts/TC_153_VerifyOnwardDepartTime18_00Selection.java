...
public class TC_153_VerifyOnwardDepartTime18_00Selection extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
     ...
     //  Map<String, String> excelData = getDataFromExcel.getExcelData("TC_153");
      ...
      Thread.sleep(3000); 
     // tripgainresultspage.validateOnwardDepartureTimeIsSelected(Log, screenShots, "18 - 00");
