...
public class TC_184_verifyBackToSearchResultFunctionality extends BaseClass {
...
tripgainhomepage.searchFlightsOnHomePage(origin, destination,  fromDate, fromMonthYear, travelClass, adults, Log, screenShots);
      ...
      tripgainresultspage.clickOnSelectFlightBasedOnIndex(index);
      Thread.sleep(3000);
      String[] resultData = tripgainresultspage.validateFlightResultInResultPage(userInput[0], userInput[1], userInput[2], Log, screenShots);
      Thread.sleep(3000);
      tripgainresultspage.clickOnContinueBookingFlightPopup();
      Thread.sleep(3000);
      tripgainresultspage.goBackToSearchResults();
      Thread.sleep(3000);
      tripgainresultspage.clickOnSelectFlightBasedOnIndex(index);
      Thread.sleep(3000);
      String[] resultData1 = tripgainresultspage.validateFlightResultInResultPage(userInput[0], userInput[1], userInput[2], Log, screenShots);
      Thread.sleep(3000);
