...
public class TC_140_VerifyByChangingCurrency extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
     ...
     //  Map<String, String> excelData = getDataFromExcel.getExcelData("TC_137");
       ...
       String currencyCode4 = excelData.get("CurrencyCode4");
      ...
      //Function to validate Default Currency Code is Selected
		...
		tripgainresultspage.selectCurrencyDropDownValues(driver, currencyCode4);

  		//tripgainresultspage.validateCurrencyOnResultScreen("EUR", Log, screenShots);
  		tripgainresultspage.validateCurrency(currencyCode4, Log, screenShots);
