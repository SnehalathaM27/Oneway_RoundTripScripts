...
public class TC_173_VerifyOnwardArrivalTime00_06Selection extends BaseClass {
   ...
   //    Map<String, String> excelData = getDataFromExcel.getExcelData("TC_173");
...
tripgainhomepage.searchFlightsOnHomePage(origin, destination,  fromDate, fromMonthYear, travelClass, adults, Log, screenShots);
      ...
      Thread.sleep(3000); 
      //tripgainresultspage.validateOnwardArrivalTime(Log, screenShots, "00 - 06");
