...
public class TC_162_VerifyResetofAllFilters extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
      ...
      // Map<String, String> excelData = getDataFromExcel.getExcelData("TC_122");
       ...
       int adults = Integer.parseInt(excelData.get("Adults"));
        ...
        tripgainresultspage.validateFlightsResults(Log, screenShots);
 		...
 		Log.ReportEvent("PASS", "Successfully clicked on policy filter");
 		screenShots.takeScreenShot1();
         Thread.sleep(3000);
         ...
         tripgainresultspage.clickOnClearFilter();
   		Log.ReportEvent("PASS", "Successfully clicked on clear filters");
 		screenShots.takeScreenShot1();
         Thread.sleep(3000); 
