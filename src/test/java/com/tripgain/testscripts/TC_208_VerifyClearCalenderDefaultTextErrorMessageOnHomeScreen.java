...
public class TC_208_VerifyClearCalenderDefaultTextErrorMessageOnHomeScreen extends BaseClass {
	WebDriver driver;    
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
        ...
        tripgainhomepage.clearcalenderdefaulttext(origin,destination,travelClass, adults,Log, screenShots);
        Thread.sleep(5000); 
        tripgainhomepage.verifyErrorMsgForCalenderField(Log,screenShots);
