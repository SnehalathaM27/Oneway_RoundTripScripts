...
public class TC_152_VerifyOnwardDepartTime12_18Selection extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
     ...
     //  Map<String, String> excelData = getDataFromExcel.getExcelData("TC_152");
      ...
      Thread.sleep(3000); 
      //tripgainresultspage.validateOnwardDepartureTimeIsSelected(Log, screenShots, "12 - 18");
