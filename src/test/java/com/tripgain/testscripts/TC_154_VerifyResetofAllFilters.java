...
public class TC_154_VerifyResetofAllFilters extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
     ...
     //  Map<String, String> excelData = getDataFromExcel.getExcelData("TC_147");
       ...
       tripgainLogin.clickButton(); 
        ...
        Thread.sleep(3000); 
        //tripgainresultspage.validateOnwardDepartureTimeIsSelected(Log, screenShots, "06 - 12");
        ...
        tripgainresultspage.clickOnClearFilter();
        Thread.sleep(3000); 
        tripgainresultspage.verifyflightscount(Log, screenShots);
