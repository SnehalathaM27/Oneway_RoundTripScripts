...
public class TC_161_VerifyUncheckingPolicyFilter extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
       ...
       Thread.sleep(2000);
        ...
        String selectFaretype = excelData.get("selectFaretype");
        ...
        Tripgain_RoundTripResultsScreen tripgain_roundtrip_resultpage= new Tripgain_RoundTripResultsScreen(driver);
     ...
     //   tripgainhomepage.searchFlightsOnHomePage("NYC", "ORD",  fromDate, fromMonthYear, "Premium Economy", 3);
        tripgainhomepage.searchFlightsOnHomePage(origin, destination,  fromDate, fromMonthYear, travelClass, adults, Log, screenShots);

        Thread.sleep(5000); 
        //Function to validate Flights
        tripgainresultspage.validateFlightsResults(Log, screenShots);
         Thread.sleep(3000);
         tripgainresultspage.getFlightsBeforeCount(Log);
         //Function to validate Policy Filter
         tripgainresultspage.clickOnPolicy();
         Thread.sleep(3000);
         tripgainresultspage.getFlightsBeforeCount(Log);
        Thread.sleep(3000); 
        tripgainresultspage.clickOnPolicy();
        tripgainresultspage.getFlightsAfterCount(Log);
