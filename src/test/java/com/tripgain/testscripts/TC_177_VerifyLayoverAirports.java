...
public class TC_177_VerifyLayoverAirports extends BaseClass {
...
Thread.sleep(6000);
        tripgainhomepage.searchFlightsOnHomePage("HYD", "BLR",  fromDate, fromMonthYear, "Premium Economy", 3, Log, screenShots);
        Thread.sleep(5000); 
        tripgainresultspage.validateFlightsResults(Log, screenShots);
        Thread.sleep(3000); 
      tripgainresultspage.clickLayoverAirport("New Delhi (DEL)");
      Thread.sleep(4000);
      tripgainresultspage.selectFlightBasedOnIndex(2);
      tripgainresultspage.validateSelectedAirport("New Delhi (DEL)", Log, screenShots);
