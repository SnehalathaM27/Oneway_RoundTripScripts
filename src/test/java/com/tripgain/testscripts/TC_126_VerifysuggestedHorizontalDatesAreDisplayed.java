...
public class TC_126_VerifysuggestedHorizontalDatesAreDisplayed extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException, TimeoutException, ParseException {
     ...
     //  Map<String, String> excelData = getDataFromExcel.getExcelData("TC_126");
       ...
       String dayAbbreviation=excelData.get("DayAbbreviation");
       int day = Integer.parseInt(excelData.get("Day"));
       String monthAbbreviation=excelData.get("MonthAbbreviation");
        ...
        Thread.sleep(2000); 
        tripgainresultspage.verifyHorizontalDatePickerIsDisplayed(Log, screenShots);
        Thread.sleep(2000); 
        tripgainresultspage.selectHorizontalDate(dayAbbreviation, day, monthAbbreviation);
        Thread.sleep(2000); 
        tripgainresultspage.verifySelectedHorizontalDatePickerIsDisplayed(Log, screenShots);
