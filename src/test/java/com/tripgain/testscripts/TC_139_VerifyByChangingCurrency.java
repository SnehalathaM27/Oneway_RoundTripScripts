...
public class TC_139_VerifyByChangingCurrency extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
     ...
     //  Map<String, String> excelData = getDataFromExcel.getExcelData("TC_137");
       ...
       String currencyCode3 = excelData.get("CurrencyCode3");
      ...
      //Function to validate Default Currency Code is Selected
		...
		tripgainresultspage.selectCurrencyDropDownValues(driver, currencyCode3);

  		//tripgainresultspage.validateCurrencyOnResultScreen("IQD", Log, screenShots);		
  		tripgainresultspage.validateCurrency(currencyCode3, Log, screenShots);
