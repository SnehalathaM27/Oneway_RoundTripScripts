...
public class TC_122_TravelerSelectionFunctionality extends BaseClass {
    ...
    //   Map<String, String> excelData = getDataFromExcel.getExcelData("TC_122");
      ...
      //  tripgainhomepage.searchFlightsOnHomePage("ORD", "MIA",  fromDate, fromMonthYear, "Premium Economy", 5, Log, screenShots);
