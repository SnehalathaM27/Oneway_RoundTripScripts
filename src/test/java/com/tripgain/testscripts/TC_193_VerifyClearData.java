...
public class TC_193_VerifyClearData extends BaseClass {
...
tripgainhomepage.setFromLocation(origin);
tripgainhomepage.clickOnFromSuggestion(); 
tripgainhomepage.setToLocation(destination);
tripgainhomepage.clickOnToSuggestion();
tripgainhomepage.clearFromDate();    
Thread.sleep(1000);
