...
public class TC_202_VerifyWorkEmailFieldErrorMsgOnRegisterScreen extends BaseClass {
	WebDriver driver;    
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException, AWTException {
       ...
       String LastName = excelData.get("lastName");
        ...
        tripgainregistrationpage.mobileNumberField(PhoneNum);
        tripgainregistrationpage.passwordField(Password);
        tripgainregistrationpage.submitButton();
        tripgainregistrationpage.verifyWorkEmailFieldErrorMessage(Log, screenShots);
       }
