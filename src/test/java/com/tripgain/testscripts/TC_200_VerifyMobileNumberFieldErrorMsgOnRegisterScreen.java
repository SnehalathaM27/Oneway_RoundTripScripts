...
public class TC_200_VerifyMobileNumberFieldErrorMsgOnRegisterScreen extends BaseClass {
	WebDriver driver;    
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException, AWTException {
       ...
       String salutation = excelData.get("Salutation");
       String FirstName = excelData.get("firstName");
       String CompanyName = excelData.get("companyName");
       String Email = excelData.get("email");
       String PhoneNum = excelData.get("phoneNum");
       String Password = excelData.get("password");
       String registerAs = excelData.get("RegisterAs");
       String LastName = excelData.get("lastName");
        ...
        tripgainregistrationpage.registerButton();
        tripgainregistrationpage.firstNameField(FirstName);
        tripgainregistrationpage.lastNameField(LastName);
        tripgainregistrationpage.companyField(CompanyName);
        tripgainregistrationpage.workEmailField(Email);
        tripgainregistrationpage.passwordField(Password);
        tripgainregistrationpage.submitButton();
        tripgainregistrationpage.verifyMobileNumberFieldErrorMessage(Log, screenShots); 
       }
