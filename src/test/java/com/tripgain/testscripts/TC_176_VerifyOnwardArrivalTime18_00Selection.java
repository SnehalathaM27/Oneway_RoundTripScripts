...
public class TC_176_VerifyOnwardArrivalTime18_00Selection extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
      ...
      // Map<String, String> excelData = getDataFromExcel.getExcelData("TC_176");
...
tripgainhomepage.searchFlightsOnHomePage(origin, destination,  fromDate, fromMonthYear, travelClass, adults, Log, screenShots);
      ...
      Thread.sleep(3000); 
      //tripgainresultspage.validateOnwardArrivalTime(Log, screenShots, "18 - 00");
