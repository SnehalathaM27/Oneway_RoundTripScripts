...
public class TC_130_VerifyclearFiltersFunctionality extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
      ...
      // Map<String, String> excelData = getDataFromExcel.getExcelData("TC_129");
      ...
      //Functions to Side and Validate Price Range Slide Bar
        tripgainresultspage.adjustMaximumSliderValue(driver,250000);
		 ...
		 //Function to validate clear Filters
