...
public class TC_209_VerifySelectingOutOfPolicyFilter extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
      ...
      // Map<String, String> excelData = getDataFromExcel.getExcelData("TC_160");
     ...
     //   tripgainhomepage.searchFlightsOnHomePage("NYC", "ORD",  fromDate, fromMonthYear, "Premium Economy", 3);
        ...
        tripgainresultspage.validateFlightsResults(Log, screenShots);
         ...
         //Function to validate Policy Fliter
         tripgainresultspage.validateOutOfPolicyFilterOneWay(3, Log, screenShots);
