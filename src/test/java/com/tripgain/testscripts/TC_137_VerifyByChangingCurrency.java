...
public class TC_137_VerifyByChangingCurrency extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
      ...
      //Function to validate Default Currency Code is Selected
    		...
    		tripgainresultspage.selectCurrencyDropDownValues(driver, currencyCode);
      		...
      		//tripgainresultspage.validateCurrencyOnResultScreen("AMD", Log, screenShots);		
      		tripgainresultspage.validateCurrency(currencyCode, Log, screenShots);
