...
public class TC_201_VerifyPasswordFieldErrorMsgOnRegisterScreen extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException, AWTException {
       ...
       String LastName = excelData.get("lastName");
        ...
        tripgainregistrationpage.verifyPasswordFieldErrorMessage(Log, screenShots);
       }
