...
public class TC_159_VerifyUnSelectingSMECorporateFareOnly extends BaseClass {
      ...
      // Map<String, String> excelData = getDataFromExcel.getExcelData("TC_158");
       ...
       //Function to Validate SME Check box Functionality
  		...
  		tripgainresultspage.validateSME(Log, screenShots);
 		  ...
 		  //Function to Validate UnselectingSME Check box Functionality
        
              tripgainresultspage.validateUnSelectingSMEFare(Log, screenShots);   
 		driver.quit();
       }
