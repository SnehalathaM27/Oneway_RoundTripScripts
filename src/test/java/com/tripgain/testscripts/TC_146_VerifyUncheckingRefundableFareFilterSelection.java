...
public class TC_146_VerifyUncheckingRefundableFareFilterSelection extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
      ...
      // Map<String, String> excelData = getDataFromExcel.getExcelData("TC_145");
       ...
       String checkinbaggageindex = excelData.get("CheckInBAggageIndex");
        ...
        //tripgainhomepage.searchFlightsOnHomePage("ORD", "MIA",  fromDate, fromMonthYear, "Premium Economy", 3, Log, screenShots);
        ...
        Thread.sleep(3000); 
        tripgainresultspage.validateUnCheckingRefundableFareFlightsBasedOnIndex(Log, screenShots);
        Thread.sleep(3000); 
        tripgainresultspage.selectFlightBasedOnIndex(1);
        Thread.sleep(3000); 
        tripgainresultspage.validateUnCheckingRefundableFareFlights(Log, screenShots);
