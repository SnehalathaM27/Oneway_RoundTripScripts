...
public class TC_149_VerifyStopsFilter_2StopSelection extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
     ...
     //  Map<String, String> excelData = getDataFromExcel.getExcelData("TC_147");
       ...
       String stops2 = excelData.get("Stops2");
       String numberofstops2 = excelData.get("NumberOfStops2");
        ...
        Thread.sleep(3000); 
       tripgainresultspage.clickOnStops(stops2);
       Thread.sleep(3000); 
       tripgainresultspage.validateFlightsStopsOnResultScreen(numberofstops2, Log, screenShots);
