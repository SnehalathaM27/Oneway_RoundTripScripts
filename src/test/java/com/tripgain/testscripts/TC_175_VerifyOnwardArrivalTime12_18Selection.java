...
public class TC_175_VerifyOnwardArrivalTime12_18Selection extends BaseClass {
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException {
      ...
      // Map<String, String> excelData = getDataFromExcel.getExcelData("TC_175");
...
tripgainhomepage.searchFlightsOnHomePage(origin, destination,  fromDate, fromMonthYear, travelClass, adults, Log, screenShots);
      ...
      Thread.sleep(3000); 
      //tripgainresultspage.validateOnwardArrivalTime(Log, screenShots, "12 - 18");
