...
public class TC_134_VerifyArrivalTimeSorting extends BaseClass {
    ...
    //   Map<String, String> excelData = getDataFromExcel.getExcelData("TC_134");
       ...
       String order2 = excelData.get("Order2");
        ...
        tripgainresultspage.validateArrivalTimeSortFunctionalityOnResultScreen(Log, screenShots, order1);
        Thread.sleep(5000);
        tripgainresultspage.clickOnFiltersOnResultScreen(filtername);
        tripgainresultspage.validateArrivalTimeSortFunctionalityOnResultScreen(Log, screenShots, order2);
    	 driver.quit();
       }
