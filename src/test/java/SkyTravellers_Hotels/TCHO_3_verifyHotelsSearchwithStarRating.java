...
public class TCHO_3_verifyHotelsSearchwithStarRating extends BaseClass{
	WebDriver driver;    
    ...
    public void myTest(Map<String, String> excelData) throws InterruptedException, IOException, ParseException, TimeoutException {
        ...
        String payment = excelData.get("Payment");
         String starCount = excelData.get("StarCount");
     ...
     // Login to TripGain Application
		...
		String starrating = SkyTravelersHotelsSearchPage.clickStarRating(starCount, Log);
		Thread.sleep(2000);
    Thread.sleep(2000);
   ...
   SkyTravelersHotelsDescriptionPage.validateCheckInDate(descPageDay, descPageMonth, checkindateResultPage, Log, screenShots);
		...
		SkyTravelersHotelsDescriptionPage.validateStarRatingFromResultToDescpage(starrating, descStarRating, Log, screenShots);
