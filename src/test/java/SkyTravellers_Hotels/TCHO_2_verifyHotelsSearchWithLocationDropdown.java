...
public class TCHO_2_verifyHotelsSearchWithLocationDropdown extends BaseClass{
	WebDriver driver;    
    ...
    String selectedLocFromDropdown = SkyTravelersHotelsSearchPage.clickAndSearchHotelLocationName(Log, screenShots);
	...
	String[] hotelcardLoc = SkyTravelersHotelsSearchPage.getHotelLocationFromCardFromResultsPage();
		...
		SkyTravelersHotelsSearchPage.validateHotelLocationFromSelectedToHotelCard(selectedLocFromDropdown, hotelcardLoc, Log, screenShots);
